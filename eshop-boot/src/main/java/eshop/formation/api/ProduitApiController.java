...
import eshop.formation.exception.ProduitNotFoundException;
import eshop.formation.exception.ProduitNotValidException;
...
public class ProduitApiController {
	...
	@PutMapping("/{id}")
	@JsonView(Views.ProduitDetail.class)
	public Produit edit(@PathVariable Long id, @Valid @RequestBody Produit produit, BindingResult result) {
		produit.setId(id);
